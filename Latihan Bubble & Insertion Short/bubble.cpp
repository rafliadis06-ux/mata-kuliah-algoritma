...
int main() {
    ...
    if (langkahBubble > langkahInsertion) {
        cout << "Insertion Sort lebih efisien dibanding Bubble Sort pada data ini." << endl;
    } else if (langkahBubble < langkahInsertion) {
        cout << "Bubble Sort lebih efisien dibanding Insertion Sort pada data ini." << endl;
    } else {
        cout << "Kedua algoritma memiliki jumlah langkah yang sama pada data ini." << endl;
    }
